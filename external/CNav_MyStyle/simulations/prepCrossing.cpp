					...
					float coordFactor, std::vector<bool> isInGoal, int numActions) //Initialize the Simulation, positions of the obstacles and the agents
{
	...
	finalGoals.push_back(RVO::Vector2(10.0f, sim->getAgentPosition(0).y()));
	finalGoals.push_back(RVO::Vector2(10.0f, sim->getAgentPosition(1).y()));
	finalGoals.push_back(RVO::Vector2(10.0f, sim->getAgentPosition(2).y()));
	finalGoals.push_back(RVO::Vector2(10.0f, sim->getAgentPosition(3).y()));
	sim->setAgentGoal(0, RVO::Vector2(10.0f, sim->getAgentPosition(0).y()));
	sim->setAgentGoal(1, RVO::Vector2(10.0f, sim->getAgentPosition(1).y()));
	sim->setAgentGoal(2, RVO::Vector2(10.0f, sim->getAgentPosition(2).y()));
	sim->setAgentGoal(3, RVO::Vector2(10.0f, sim->getAgentPosition(3).y()));
...
int main()
{
	...
	std::string filePath = "/Users/tamurashuntarou/Downloads/CML/results/CNav/bidirectional/result.csv";
	outputFile.open(filePath);
	
	std::ofstream positionFile;
	std::string positionFilePath = "/Users/tamurashuntarou/Downloads/CML/results/CNav/bidirectional/position.csv";

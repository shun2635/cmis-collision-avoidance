...
int algo,numAgents, scenario, notFinished, Actions,chosenAction[320], bestSimilarNeigh[320], currentVel[320], totalConsideredNeighbors[320], mostSimilarAgentID[320],ascendingSimilarAgentIDList[320][50], iteration, timestep, lastFrameTime = 0, totalNotInGoal,numAgentInGoal,finalIteration;
bool isinGoal[320],visualizer, evalMethod[320], loop[320];
float ori[750];
RVO::Vector2 goalVectors[320],goalVector, initPos[320];
std::vector<RVO::Vector2> finalGoals;
float totalMotion=0, angle,dist,actionVector[50],actionVectorMag[50],finalTime=-100,oriMostSimilar[320][50], totalReward[320][50],timeToGoal[320],goalDistance[320],ActionSpeed[320][50],ActionDirection[320][50], goalX[320], goalY[320],totalRewardSimulation=0,totalRewardIteration, needToUpdate[320], LastActionEstimate[320][20], Boltz[320][20],defaultValue[320][20];

...
- upstream `Circle` 比較の入口をどこに置くかを明確にする
...
- `external/RVO2/src/Agent.cc`
  ...
  - 線形計画による速度決定
  - 位置と速度の更新
- `external/RVO2/examples/Circle.cc`
  - 250 体の circle scenario と目標更新の参照元

upstream `Circle` に対する現行の比較基盤は [../specifications/upstream-circle-regression.md](../specifications/upstream-circle-regression.md) に記録する。

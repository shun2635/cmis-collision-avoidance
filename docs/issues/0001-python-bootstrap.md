...
`共通コア + アルゴリズム切替` を前提にした構造案は [docs/repository-architecture.md](../repository-architecture.md) で整理済みであり、ORCA の責務境界も [docs/algorithms/orca.md](../algorithms/orca.md) で先に固定できた。  

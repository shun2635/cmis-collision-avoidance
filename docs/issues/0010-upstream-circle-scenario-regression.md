...
- `scenarios/upstream_circle.yaml` に 250 体の比較用 scenario を追加した
- `src/cmis_ca/regression/upstream_circle.py` で scenario-defined goals を使った metric 集計を実装した
- `tests/regression/test_upstream_circle.py` で対称性と内向き収束を固定した

## 依存関係

- [0008-orca-step-integration.md](0008-orca-step-integration.md): completed
- [0009-scenario-schema-and-loader.md](0009-scenario-schema-and-loader.md): completed
